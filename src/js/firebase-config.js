...
import { getAuth, onAuthStateChanged, signInWithEmailAndPassword, browserLocalPersistence, browserSessionPersistence, setPersistence } from 'https://www.gstatic.com/firebasejs/10.8.0/firebase-auth.js';
...
setPersistence(auth, isElectron ? browserSessionPersistence : browserLocalPersistence)
    .catch((error) => {
