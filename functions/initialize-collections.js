...
const serviceAccount = require("./booking-b1567-firebase-adminsdk-fbsvc-5eef73dc03.json");

// Initialize Firebase Admin with service account
admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://booking-b1567.firebaseio.com"
});
                ...
                for (const slot of TIME_SLOTS.filter((s) => s.day === day)) {
                    ...
                    addTimeSlotsPromises.push(
                        db.collection(COLLECTIONS.TIME_SLOTS).add({
                            region: region.name, // Use the original region name for display
                            regionId: regionName, // Add a regionId field for container matching
                            product: product,
                            time: slot.time,
